    ...
    <div class="row">
        ...
        <div class="box panel card box-solid">
            <div class="box-header panel-header card-header with-border">
                ...
                <h3 class="box-title panel-title card-title">Id</h3>
            </div>
            <!-- /.box-header panel-header card-header -->
            <div class="box-body panel-body card-body">
                <blockquote>
        ...
        <div class="box panel card box-solid">
            <div class="box-header panel-header card-header with-border">
                ...
                <h3 class="box-title panel-title card-title">name</h3>
            </div>
            <!-- /.box-header panel-header card-header -->
            <div class="box-body panel-body card-body">
                <blockquote>
        ...
        <div class="box panel card box-solid">
            <div class="box-header panel-header card-header with-border">
                ...
                <h3 class="box-title panel-title card-title">email</h3>
            </div>
            <!-- /.box-header panel-header card-header -->
            <div class="box-body panel-body card-body">
                <blockquote>
        ...
        <div class="box panel card box-solid">
            <div class="box-header panel-header card-header with-border">
                ...
                <h3 class="box-title panel-title card-title">cpf</h3>
            </div>
            <!-- /.box-header panel-header card-header -->
            <div class="box-body panel-body card-body">
                <blockquote>
        ...
        <div class="box panel card box-solid">
            <div class="box-header panel-header card-header with-border">
                ...
                <h3 class="box-title panel-title card-title">role_id</h3>
            </div>
            <!-- /.box-header panel-header card-header -->
            <div class="box-body panel-body card-body">
                <blockquote>
        ...
        <div class="box panel card box-solid">
            <div class="box-header panel-header card-header with-border">
                ...
                <h3 class="box-title panel-title card-title">score_points</h3>
            </div>
            <!-- /.box-header panel-header card-header -->
            <div class="box-body panel-body card-body">
                <blockquote>
