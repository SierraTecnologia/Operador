...
@section('content')
    ...
    <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                    <div class="box-header card-header with-brunner">
                        <i class="fa fa-text-width"></i>
                
                        <h3 class="box-title card-title">Customer</h3>
                      </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                        <div class="box-header card-header with-brunner">
                            ...
                            <h3 class="box-title card-title">customer_info</h3>
                      </div>
                      <!-- /.box-header card-header -->
                      <div class="box-body card-body">
                        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">Runner Origin</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">payment_type_id</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">company_token</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">is_active</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">gateway</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
        <div class="box-header card-header with-brunner">
            ...
            <h3 class="box-title card-title">gateway_mundipagg_public</h3>
          </div>
          <!-- /.box-header card-header -->
          <div class="box-body card-body">
            <blockquote>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                  <div class="box-header card-header with-brunner">
                      ...
                      <h3 class="box-title card-title">gateway_mundipagg_secret</h3>
                    </div>
                    <!-- /.box-header card-header -->
                    <div class="box-body card-body">
                      <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">gateway_pagseguro_public</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
              <div class="box-header card-header with-brunner">
                  ...
                  <h3 class="box-title card-title">gateway_pagseguro_secret</h3>
                </div>
                <!-- /.box-header card-header -->
                <div class="box-body card-body">
                  <blockquote>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
              <div class="box-header card-header with-brunner">
                  ...
                  <h3 class="box-title card-title">gateway_rede_public</h3>
                </div>
                <!-- /.box-header card-header -->
                <div class="box-body card-body">
                  <blockquote>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                        <div class="box-header card-header with-brunner">
                            ...
                            <h3 class="box-title card-title">gateway_rede_secret</h3>
                          </div>
                          <!-- /.box-header card-header -->
                          <div class="box-body card-body">
                            <blockquote>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                        <div class="box-header card-header with-brunner">
                            ...
                            <h3 class="box-title card-title">gateway_cielo_public</h3>
                          </div>
                          <!-- /.box-header card-header -->
                          <div class="box-body card-body">
                            <blockquote>
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
                                  <div class="box-header card-header with-brunner">
                                      ...
                                      <h3 class="box-title card-title">gateway_cielo_secret</h3>
                                    </div>
                                    <!-- /.box-header card-header -->
                                    <div class="box-body card-body">
                                      <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box card box-solid">
    <div class="box-header card-header with-brunner">
        ...
        <h3 class="box-title card-title">Payment Service Token</h3>
      </div>
      <!-- /.box-header card-header -->
      <div class="box-body card-body">
        <blockquote>
