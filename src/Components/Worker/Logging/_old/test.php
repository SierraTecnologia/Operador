...
echo test($type, $regex, $match, $types, $log);
?></div></div><div class="tab-pane" id="configurationtab"><div class="box-body panel-body card-body"><div class="panel-group" id="accordion2"><div class="card card-default"><div class="card-header"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapseOne2">Code <code><?php echo get_config_file_path();?></code></a></h4></div><div id="collapseOne2" class="panel-collapse collapse"><div class="box-body panel-body card-body"><pre><?php if (file_exists(get_config_file_path())) { show_source(get_config_file_path());
} else { echo 'configuration file does not exist';
} ?></pre></div></div></div><div class="card card-default"><div class="card-header"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo2">Stats <code><?php echo get_config_file_path();?></code></a></h4></div><div id="collapseTwo2" class="panel-collapse collapse"><div class="box-body panel-body card-body"><pre><?php if (file_exists(get_config_file_path()) ) { var_export(@stat(get_config_file_path()));
} else { echo 'configuration file does not exist';
} ?></pre></div></div></div><div class="card card-default"><div class="card-header"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapseFive2"><?php
...
?></a></h4></div><div id="collapseFive2" class="panel-collapse collapse"><div class="box-body panel-body card-body"><pre><?php
...
?></pre></div></div></div><div class="card card-default"><div class="card-header"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapseFour2"><?php _e('Rights');?></a></h4></div><div id="collapseFour2" class="panel-collapse collapse"><div class="box-body panel-body card-body"><pre><?php
...
?></pre><?php
                                        ...
                                        ?></div></div></div><div class="card card-default"><div class="card-header"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapseSix2">PHP Modules</a></h4></div><div id="collapseSix2" class="panel-collapse collapse"><div class="box-body panel-body card-body"><?php
...
if (GETTEXT_SUPPORT === true ) {
    ...
    echo ' <span class="text-muted">(' . sprintf(__('Follow instructions %shere%s to enable'), '<a href="http://php.net/manual/en/gettext.installation.php" target="_blank">', '</a>') . ')</span>';
                                        ...
                                        echo '</ul>';
?></div></div></div><div class="card card-default"><div class="card-header"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion2" href="#collapseThree2">PHPInfo</a></h4></div><div id="collapseThree2" class="panel-collapse collapse"><div class="box-body panel-body card-body"><?php
                                    ob_start();
                                    phpinfo();
